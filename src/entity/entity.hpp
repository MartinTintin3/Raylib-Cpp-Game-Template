...
class Entity {
	public:
		Entity(Vector2 position, Vector2 size, Color color = RED, Health health = Health{ 100 }, bool should_interpolate = true, bool has_physics = false);
	...
	protected:
		...
		virtual void apply_physics(const double& delta) final;
};
